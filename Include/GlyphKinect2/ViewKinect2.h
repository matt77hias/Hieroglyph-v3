...
//--------------------------------------------------------------------------------
#ifndef ViewKinect2_h
#define ViewKinect2_h
//--------------------------------------------------------------------------------
#include "Task.h"
#include "UnorderedAccessParameterDX11.h"
#include "ShaderResourceParameterDX11.h"
#include "VectorParameterDX11.h"
#include "Kinect2SkeletonActor.h"
//--------------------------------------------------------------------------------
namespace Glyph3
{
	class KinectManager;

	class ViewKinect2 : public Task
	{
	public:
		ViewKinect2( RendererDX11& Renderer );
		virtual ~ViewKinect2();
		...
		void SetSkeletonActor( Kinect2SkeletonActor* pActor );
