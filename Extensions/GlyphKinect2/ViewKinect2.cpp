...
//--------------------------------------------------------------------------------
#include "GlyphKinect2/ViewKinect2.h"
...
//--------------------------------------------------------------------------------
ViewKinect2::ViewKinect2( RendererDX11& Renderer )
{
...
//--------------------------------------------------------------------------------
void ViewKinect2::Update( float fTime )
{
}
//--------------------------------------------------------------------------------
void ViewKinect2::QueuePreTasks( RendererDX11* pRenderer )
{
...
//--------------------------------------------------------------------------------
void ViewKinect2::ExecuteTask( PipelineManagerDX11* pPipelineManager, IParameterManager* pParamManager )
{
...
//--------------------------------------------------------------------------------
void ViewKinect2::SetRenderParams( IParameterManager* pParamManager )
{
...
//--------------------------------------------------------------------------------
void ViewKinect2::SetUsageParams( IParameterManager* pParamManager )
{
...
//--------------------------------------------------------------------------------
ResourcePtr ViewKinect2::GetColorResource()
{
	return( KinectColor );
}
//--------------------------------------------------------------------------------
ResourcePtr ViewKinect2::GetDepthResource()
{
	return( KinectDepth );
}
//--------------------------------------------------------------------------------
void ViewKinect2::SetSkeletonActor( KinectSkeletonActor* pActor )
{
	m_pSkeletonActor = pActor;
}
//--------------------------------------------------------------------------------
std::wstring ViewKinect2::GetName()
{
	return( L"ViewKinect2" );
}
//--------------------------------------------------------------------------------